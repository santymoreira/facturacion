...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" lang="<?php echo e(App::getLocale()); ?>">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <!--[if !mso]><!-- -->
    <link href="<?php echo e(isset($account) ? $account->getFontsUrl('http') : ''); ?>" rel="stylesheet" type="text/css" />
    <!--<![endif]-->
</head>
<body style="color: #000000;<?php echo isset($account) ? $account->getBodyFontCss() : ''; ?>font-size: 12px; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; background: #F4F5F5; margin: 0; padding: 0;" 
    ...
    <div id="body_style" style="<?php echo isset($account) ? $account->getBodyFontCss() : ''; ?>;color: #2E2B2B; font-size: 16px; 
