...
<?php $__env->startSection('content'); ?>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?php if(!$expense || ($expense && !$expense->invoice_id && !$expense->client_id)): ?>
                    ...
                    <div style="display:none" data-bind="visible: enableExchangeRate">
                        ...
                        <span style="display:none;" data-bind="visible: client_id">
                            <?php echo Former::plaintext('test')
                ...
                <div class="col-md-6">
                    ...
                    <?php echo Former::textarea('public_notes')->rows(8); ?>

                    <?php echo Former::textarea('private_notes')->rows(8); ?>
            ...
            <div clas="row">
                <div class="col-md-2 col-sm-4"><div class="control-label" style="margin-bottom:10px;"><?php echo e(trans('texts.expense_documents')); ?></div></div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#expense_date').datepicker('update', '<?php echo e($expense ? $expense->expense_date : 'new Date()'); ?>');
            ...
            dropzone = new Dropzone('#document-upload', {
                ...
                <?php foreach(['default_message', 'fallback_message', 'fallback_text', 'file_too_big', 'invalid_file_type', 'response_error', 'cancel_upload', 'cancel_upload_confirmation', 'remove_file'] as $key): ?>
                    "dict<?php echo e(strval($key)); ?>":"<?php echo e(trans('texts.dropzone_'.Utils::toClassCase($key))); ?>",
                <?php endforeach; ?>
