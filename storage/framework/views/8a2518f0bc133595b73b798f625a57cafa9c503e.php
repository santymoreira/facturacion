<?php $__env->startSection('head'); ?>
  ...
  <script src="<?php echo asset('js/d3.min.js'); ?>" type="text/javascript"></script>   
...
<?php $__env->startSection('content'); ?>
  @parent
  <?php echo $__env->make('accounts.nav', ['selected' => ACCOUNT_DATA_VISUALIZATIONS, 'advanced' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script type="text/javascript">
    ...
    function calculateInvoiceAge(invoice) {
      ...
      <?php if(Auth::user()->account->hasFeature(FEATURE_REPORTS)): ?>
