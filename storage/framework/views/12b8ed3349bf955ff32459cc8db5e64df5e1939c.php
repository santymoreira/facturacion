...
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-lg-8 col-sm-8">
						<?php foreach(\App\Models\Account::$modules as $entityType => $value): ?>
						<div class="checkbox">
							<label for="modules_<?php echo e($value); ?>">
								<input name="modules[]" id="modules_<?php echo e($value); ?>" type="checkbox" <?php echo e(Auth::user()->account->isModuleEnabled($entityType) ? 'checked="checked"' : ''); ?> value="<?php echo e($value); ?>"><?php echo e(trans("texts.{$entityType}s")); ?>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo trans('texts.cancel_account'); ?></h3>
			</div>
			<div class="panel-body">
				<?php echo Former::actions( Button::danger(trans('texts.cancel_account'))->large()->withAttributes(['onclick' => 'showConfirm()'])->appendIcon(Icon::create('trash'))); ?>
			...
			<div class="modal-dialog" style="min-width:150px">
				<div class="modal-content">
					...
					<div style="background-color: #fff; padding-left: 16px; padding-right: 16px">
						&nbsp;<p><?php echo e(trans('texts.cancel_account_message')); ?></p>&nbsp;
						&nbsp;<p><?php echo Former::textarea('reason')->placeholder(trans('texts.reason_for_canceling'))->raw(); ?></p>&nbsp;
					</div>

					<div class="modal-footer" style="margin-top: 0px">
						<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('texts.go_back')); ?></button>
						<button type="button" class="btn btn-danger" onclick="confirmCancel()"><?php echo e(trans('texts.cancel_account')); ?></button>
					</div>
