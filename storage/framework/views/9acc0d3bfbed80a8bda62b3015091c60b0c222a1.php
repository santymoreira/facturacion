  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo e(trans('texts.keyboard_shortcuts')); ?></h4>
      </div>
      <div class="panel-body help-panel">
          ...
          <div class="row">
              ...
              <div class="col-md-3 key-label"><?php echo e(trans('texts.toggle_menu')); ?></div>
          ...
          <div class="row">
              ...
              <div class="col-md-3 key-label"><?php echo e(trans('texts.toggle_history')); ?></div>
          </div>
          <div class="row">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        Mousetrap.bind('g s', function(e) {
            location.href = "<?php echo e(url('/settings/company_details')); ?>";
        });
        ...
        <?php foreach([
            ...
            Mousetrap.bind('n <?php echo e($key); ?>', function(e) {
                location.href = "<?php echo e(url($value . 's/create')); ?>";
            });
