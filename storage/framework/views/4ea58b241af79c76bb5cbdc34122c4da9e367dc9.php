    ...
    <?php if(!isset($_ENV['POSTMARK_API_TOKEN'])): ?>
        <div class="panel panel-default">
          ...
          <div class="panel-body form-padding-right">
            ...
            <?php echo Former::text('mail[from][address]')->label('From Address')
            ...
            <div id="mailgunMailSetup">
              ...
              <?php echo Former::actions( Button::primary('Send test email')->small()->withAttributes(['onclick' => 'testMail()']), '&nbsp;&nbsp;<span id="mailTestResult"/>' ); ?>
