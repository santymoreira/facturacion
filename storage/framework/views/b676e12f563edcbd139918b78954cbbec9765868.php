...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row" style="min-height:195px" onkeypress="formEnterClick(event)">
		...
		<div class="col-md-4" id="col_2">
			<div data-bind="visible: !is_recurring()">
                ...
                <?php echo Former::text('partial')->data_bind("value: partial, valueUpdate: 'afterkeydown'")->onkeyup('onPartialChange()')
				...
				<td class="hide-border" colspan="<?php echo e(2 + ($account->showCustomField('custom_invoice_item_label1') ? 1 : 0) + ($account->showCustomField('custom_invoice_item_label2') ? 1 : 0)); ?>" rowspan="6" style="vertical-align:top">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="notes" style="padding-bottom:44px">
                            <?php echo Former::textarea('public_notes')->data_bind("value: public_notes, valueUpdate: 'afterkeydown'")
                            ->label(null)->style('width: 500px;')->rows(4); ?>

                        </div>
                        <div role="tabpanel" class="tab-pane" id="terms">
                            <?php echo Former::textarea('terms')->data_bind("value:terms, placeholder: terms_placeholder, valueUpdate: 'afterkeydown'")
                        ...
                        <div role="tabpanel" class="tab-pane" id="footer">
                            <?php echo Former::textarea('invoice_footer')->data_bind("value:invoice_footer, placeholder: footer_placeholder, valueUpdate: 'afterkeydown'")
                            ->label(false)->style('width: 500px')->rows(4)
                            ->help('<div class="checkbox">
                                        <label>
            ...
            <?php else: ?>
                <?php if(!$invoice->is_deleted): ?>
					...
					<?php else: ?>
						...
						<?php echo Button::success(trans("texts.mark_sent"))->withAttributes(array('id' => 'saveButton', 'onclick' => 'onMarkSentClick()'))->appendIcon(Icon::create('globe')); ?>
                    ...
                    <?php if(!$invoice->trashed()): ?>
                        ...
                        <?php elseif( ! $invoice->isQuote() && Request::is('*/clone')): ?>
	...
	<?php if(Auth::user()->account->live_preview): ?>
    ...
    function onRecurrClick() {
        ...
        if (invoice.is_recurring()) {
            var recurring = false;
            var label = "<?php echo e(trans('texts.enable_recurring')); ?>";
        } else {
            var recurring = true;
            var label = "<?php echo e(trans('texts.disable_recurring')); ?>";
        }
    ...
    function onFormSubmit(event) {
        ...
        <?php if(Auth::user()->canCreateOrEdit(ENTITY_INVOICE, $invoice)): ?>
            ...
            $.post('<?php echo e(url($url)); ?>', $('.main-form').serialize(), function(data) {
                ...
                swal("<?php echo trans('texts.invoice_save_error'); ?>", error);
            });
            return false;
        <?php else: ?>
            return false;
