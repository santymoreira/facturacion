...
$LANG = array(
    ...
    'confirmation_required' => 'Por favor confirme su dirección de correo electrónico, <a href=\'/resend_confirmation\'>click here</a> enviar el correo de confirmación.',
    ...
    'hide_quantity_help' => 'Desabilitar la columna de cantidad',
    ...
    'payment_title' => 'Ingresa la Dirección de Facturación de tu Tarjeta de Crédito',
    ...
    'activity_30' => ':user proveedor creado :vendor',
    'activity_31' => ':user proveedor guardado :vendor',
    'activity_32' => ':user proveedor eliminado :vendor',
    'activity_33' => ':user proveedor restaurado :vendor',
    'activity_34' => ':user gasto creado :expense',
    'activity_35' => ':user gasto guardado :expense',
    'activity_36' => ':user gasto eliminado :expense',
    'activity_37' => ':user gasto restaurado :expense',
    'activity_42' => ':user tarea creada :task',
    'activity_43' => ':user tarea actualizada :task',
    'activity_44' => ':user tarea guardada :task',
    'activity_45' => ':user tarea eliminada :task',
    'activity_46' => ':user tarea restaurada :task',
    'activity_47' => ':user tarea actualizada :expense',
    'payment' => 'pago',
    'system' => 'Sistema',
    ...
    'custom_client_fields_helps' => 'Agregar una entrada de texto a la página de crear/editar cliente y mostrar la etiqueta y el valor en el PDF.',
    'custom_account_fields_helps' => 'Añadir una etiqueta y valor a la sección de detalles de la empresa del PDF.',
    'custom_invoice_fields_helps' => 'Agregar una entrada de texto a la página de crear/editar factura y mostrar la etiqueta y el valor en el PDF.',
    'custom_invoice_charges_helps' => 'Agregar una entrada de texto a la página de crear/editar factura y mostrar la carga en los subtotales de la factura.',
    'token_expired' => 'Token de validación ha caducado. Por favor, vuelva a intentarlo.',
    'invoice_link' => 'Enlace a Factura',
    'button_confirmation_message' => 'Pulse aquí para confirmar su dirección de correo.',
    'confirm' => 'Confirmar',
    ...
    'recurring_due_date_help' => '<p>Define automáticamente una fecha de vencimiento de la factura.</p>
        <p>Facturas en un ciclo mensual o anual preparadas para vencer el día que se crearon o antes, vencerán al siguiente mes. Facturas preparadas para vencer el 29 o el 30, en los meses que no tienen ese día, vencerán el último día del mes</p>
         <p>(Facturas con ciclo mensual o anual preparadas para vencer en o antes del día en que son creadas serán pagadas el mes siguiente. Las facturas preparadas para vencer el 29 o 30 en meses que no tienen ese día serán pagadas el último día del mes.)</p>
        ...
        <p>(Facturas en un ciclo semanal preparadas para vencer en el día de la semana que son creadas seraán pagadas a la semana siguiente.)</p>
        <p>Por ejemplo:</p>
        <ul>
    ...
    'day_of_week_after' => ':ordinal :day después',
    'sunday' => 'Domingo',
    'monday' => 'Lunes',
    'tuesday' => 'Martes',
    'wednesday' => 'Miércoles',
    ...
    'enable_https' => 'Se recomienda severamente tener HTTPS para aceptar tarjetas de crédito en línea.',
    ...
    'limit_users' => 'Lo sentimos, esta acción excederá el límite de :limit usuarios',
    ...
    'partial_due' => 'Pago parcial',
    'restore_vendor' => 'Restaurar Proveedor',
    'restored_vendor' => 'Proveedor restaurado exitosamente',
    'restored_expense' => 'Gasto restaurado exitosamente',
    'permissions' => 'Permisos',
    'create_all_help' => 'Permitir al usuario crear y modificar registros',
    'view_all_help' => 'Permitir al usuario ver registros que no han sido creados por él',
    'edit_all_help' => 'Permitir al usuario modificar registros que no han sido creados por él',
    'view_payment' => 'Ver forma de pago',
    ...
    'email_documents_example_1' => 'Widgets Recibo.pdf',
    'email_documents_example_2' => 'Final Entregable.zip',
    ...
    'documents_from_expenses' => 'Desde Expenses:',
    'dropzone_default_message' => 'Eliminar archivos o dar click para subir archivos',
    'dropzone_fallback_message' => 'Su navegador no soporta la función drag & drop para la carga de archivos.',
    'dropzone_fallback_text' => 'Por favor use la forma de retroceso de abajo para actualizar los archivos.',
    'dropzone_file_too_big' => 'El archivo es muy grande ({{filesize}}MiB). Máximo filesize: {{maxFilesize}}MiB.',
    'dropzone_invalid_file_type' => 'No es posible subir archivos de éste tipo.',
    'dropzone_response_error' => 'El servidor a respondido con el código {{statusCode}}.',
    'dropzone_cancel_upload' => 'Cancelar subida',
    'dropzone_cancel_upload_confirmation' => 'Está seguro de cancelar la subida del archivo?',
    'dropzone_remove_file' => 'Eliminar archivo',
    'documents' => 'Documentos',
    'document_date' => 'Fecha del documento',
    'document_size' => 'Tamaño',

    'enable_client_portal' => 'Tablero de control',
    'enable_client_portal_help' => 'Mostrar/Ocultar el tablero de control en el portal del cliente.',
    'enable_client_portal_dashboard' => 'Tablero de control',
    'enable_client_portal_dashboard_help' => 'Mostrar/Ocultar el tablero de control en el portal del cliente.',
    ...
    'pending_change_to' => 'Cambiar a',
    'plan_changes_to' => ':plan en :date',
    'plan_term_changes_to' => ':plan (:term) en :date',
    'cancel_plan_change' => 'Cancelar cambio',
    'plan' => 'Plan',
    'expires' => 'Caducidad',
    'renews' => 'Renovar',
    'plan_expired' => ':plan Plan Expirado',
    'trial_expired' => ':plan Plan de prueba finalizado',
    'never' => 'Nunca',
    'plan_free' => 'Gratis',
    'plan_pro' => 'Profesional',
    'plan_enterprise' => 'Enterprise',
    'plan_white_label' => 'Alojamiento Propio',
    ...
    'updated_plan' => 'Ajustes de plan actualizado',
    'plan_paid' => 'Témino Iniciado',
    'plan_started' => 'Plan Iniciado',
    'plan_expires' => 'Plan Expirado',
    ...
    // Payment updates
    'refund_payment' => 'Reembolso del pago',
    'refund_max' => 'Max:',
    'refund' => 'Reembolso',
    'are_you_sure_refund' => 'Reembolsar los siguientes pagos?',
    ...
    'activity_39' => ':user canceló un pago de :payment_amount (:payment)',
    'activity_40' => ':user realizó un reembolso de :adjustment de un pago de :payment_amount (:payment)',
    ...
    'created_products' => 'Successfully created :count producto(s)',
    ...
    // Payment types
    'payment_type_Apply Credit' => 'Crédito Directo',
    ...
    'payment_type_Credit Card Other' => 'Otra',
    'payment_type_PayPal' => 'PayPal',
    ...
    // Industries
    'industry_Accounting & Legal' => 'Contabilidad & Leyes',
    'industry_Advertising' => 'Publicidad',
    'industry_Aerospace' => 'Aeroespacial',
    'industry_Agriculture' => 'Agricultura',
    'industry_Automotive' => 'Automovilística',
    'industry_Banking & Finance' => 'Banca & Finanzas',
    'industry_Biotechnology' => 'Biotecnología',
    'industry_Broadcasting' => 'Radiodifusión',
    'industry_Business Services' => 'Servicios Empresariales',
    'industry_Commodities & Chemicals' => 'Productos básicos & Químicos',
    'industry_Communications' => 'Comunicaciones',
    'industry_Computers & Hightech' => 'Computadoras & Alta tecnología',
    'industry_Defense' => 'Defensa',
    'industry_Energy' => 'Energía',
    'industry_Entertainment' => 'Entretenimiento',
    'industry_Government' => 'Gobierno',
    'industry_Healthcare & Life Sciences' => 'Salud & Ciencias de la Vida',
    'industry_Insurance' => 'Seguros',
    'industry_Manufacturing' => 'Manufactura',
    'industry_Marketing' => 'Marketing',
    'industry_Media' => 'Media',
    'industry_Nonprofit & Higher Ed' => 'Sin fines de lucro & Educación Superior',
    'industry_Pharmaceuticals' => 'Farmacéutica',
    'industry_Professional Services & Consulting' => 'Servicios Profesionales & Consultoría',
    'industry_Real Estate' => 'Bienes Raíces',
    'industry_Retail & Wholesale' => 'Venta al por mayor y menor',
    'industry_Sports' => 'Deportes',
    'industry_Transportation' => 'Transporte',
    'industry_Travel & Luxury' => 'Viajes',
    'industry_Other' => 'Otros',
    ...
    // Payment types
    'payment_type_Apply Credit' => 'Crédito',
    'payment_type_Bank Transfer' => 'Transferencia Bancaria',
    'payment_type_Cash' => 'Efectivo',
    'payment_type_Debit' => 'Débito',
    'payment_type_ACH' => 'ACH',
    ...
    'view_client_portal' => 'Ver el portal del cliente',
    ...
    'new_expense_category' => 'Nueva Categoría de Gastos',
    'edit_category' => 'Editar Categoría',
    'archive_expense_category' => 'Archivar Categoría',
    'expense_categories' => 'Categorías de Gastos',
    'list_expense_categories' => 'Listar Categorías de Gastos',
    'updated_expense_category' => 'Actualización de categoría de gastos exitosa',
    'created_expense_category' => 'Creación de categoría de gastos exitosa',
    'archived_expense_category' => 'Archivación de categoría de gastos exitosa',
    'archived_expense_categories' => 'Exitosamente archivados :count categorías de gastos',
    'restore_expense_category' => 'Restaurar categoría de gasto',
    'restored_expense_category' => 'Restauración de categoría de gasto exitosa',
    'apply_taxes' => 'Aplicar impuestos',
    'min_to_max_users' => ':min a :max usuarios',
    'max_users_reached' => 'Se ha alcanzado el máximo número de usuarios.',
    'buy_now_buttons' => 'Comprar Botones Ahora',
    ...
    'fields' => 'Campos',
    'dwolla' => 'Dwolla',
    'buy_now_buttons_warning' => 'Nota: los registros de clientes y factura han sido credos incluso si la transacción no se ha completado.',
    ...
    'changes_take_effect_immediately' => 'Nota: los cambios tendrán efecto immediatamente',
    'wepay_account_description' => 'Payment gateway for Invoice Ninja',
    'payment_error_code' => 'Se ha producido un error procesando su pago [:code]. POr favor intente de nuevo.',
    'standard_fees_apply' => 'Las tarifas estándar aplican: 2.9% + $0.30 por carga exitosa.',
    ...
    'no_undo' => 'Advertencia: Ésto no se podrá deshacer.',
    ...
    'payment_type_on_file' => ':type de archivo',
    'invoice_for_client' => 'Factura :invoice para :client',
    'intent_not_found' => 'Lo sentimos, No estamos seguros de lo que solicita.',
    'intent_not_supported' => 'Lo sentimos, No es posible hacer eso.',
    'client_not_found' => 'No ha sido posible encontrar el cliente',
    'not_allowed' => 'Lo sentimos, no cuenta con los permisos necesarios',
    'bot_emailed_invoice' => 'Su factura ha sido enviada.',
    'bot_emailed_notify_viewed' => 'Será notificado vía mail cuando el destinatario lo lea.',
    'bot_emailed_notify_paid' => 'Será notificado vía mail cuando sea pagado.',
    ...
    'bot_welcome' => 'Su cuenta ha sido verificado.<br/>',
    'email_not_found' => 'No ha sido posible encontrar una cuenta disponible para la dirección :email',
    'invalid_code' => 'El código no es correcto',
    'security_code_email_subject' => 'Security code for Invoice Ninja Bot',
    'security_code_email_line1' => 'This is your Invoice Ninja Bot security code.',
    'security_code_email_line2' => 'Nota: Expirará en 10 minutos.',
    ...
    'include_item_taxes_inline' => 'Incluir <b>impuestosen el total</b>',
    'created_quotes' => 'Se ha creado exitosamente :count cuota(s)',
    ...
    'week' => 'Semana',
    'month' => 'Mes',
    'inactive_logout' => 'Su sesión ha expirado por inactividad',
    'reports' => 'Reportes',
    ...
    'max_limit' => 'Max: :max',
    'no_limit' => 'Sin Limits',
    'set_limits' => 'Configurar :gateway_type Limite',
    'enable_min' => 'Habilitar min',
    'enable_max' => 'Habilitar max',
    'min' => 'Min',
    'max' => 'Max',
    'limits_not_met' => 'Esta factura no alcanza los límites para este tipo de pago.',

    'date_range' => 'Rango de fechas',
    'raw' => 'Raw',
    'raw_html' => 'Raw HTML',
    'update' => 'Actualizar',
    'invoice_fields_help' => 'Arrastrar y soltar los campos para para cambiar orden y localización',
    'new_category' => 'Nueva Categoría',
    'restore_product' => 'Restaurar Producto',
    'blank' => 'Blank',
    'invoice_save_error' => 'Hubo un error al guardar su factura.',
    'enable_recurring' => 'Habilitar Periodicidad',
    'disable_recurring' => 'Deshabilitar Periodicidad',
    'text' => 'Texto',
    'expense_will_create' => 'el gasto será creado',
    'expenses_will_create' => 'los gastos serán creados',
    'created_expenses' => 'Se han creado exitosamente :count gasto(s)',
    ...
    'upgrade_for_features' => 'Mejorar para más funcionalidades',
...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'entity_state' => 'State',
    'payment_status_name' => 'Estado',
    'client_created_at' => 'Fecha de creación',
    'postmark_error' => 'Se ha producido un problema al enviar el mail a través de Postmark: :link',
    'project' => 'Proyecto',
    'projects' => 'Proyectos',
    ...
    'updated_project' => 'Proyecto actualizados exitosamente',
    'created_project' => 'Proyecto creado exitosamente',
    'archived_project' => 'Proyecto archivo exitosamente',
    'archived_projects' => 'Se han archivado exitosamente :count proyectos',
    'restore_project' => 'Restaurar proyecto',
    'restored_project' => 'Proyecto restaurado exitosamente',
    'delete_project' => 'Eliminar proyecto',
    'deleted_project' => 'Proyecto eliminado exitosamente',
    'deleted_projects' => 'Se ha eliminado exitosamente :count proyectos',
    'delete_expense_category' => 'Eliminar categoría',
    'deleted_expense_category' => 'Categoría eliminada exitosamente',
    'delete_product' => 'Eliminar producto',
    'deleted_product' => 'Producto eliminado exitosamente',
    'deleted_products' => 'Se ha eliminado exitosamente :count productos',
    'restored_product' => 'Producto restaurado exitosamente',
    'update_credit' => 'Actualizar crédito',
    'updated_credit' => 'Crédito actualizado exitosamente',
    'edit_credit' => 'Editar crédito',
    'live_preview_help' => 'Vista prévia del PDF en la página de factura.<br/>Desabilite paar mejorar el desempeño al editar facturas.',
    ...
    'marked_sent_invoice' => 'Factura enviada exitosamente marcada',
    'marked_sent_invoices' => 'Facturas enviadas exitosamente marcadas',
